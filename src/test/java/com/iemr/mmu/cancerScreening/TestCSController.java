...
public class TestCSController
{
	...
	public static void initializeParams(){
		...
		try
		{
			...
			when(cSServiceImplMock.getBenDataFrmNurseToDocVisitDetailsScreen(beneficiaryRegID, benVisitID)).thenReturn("");
			...
			when(cSServiceImplMock.getBenDataFrmNurseToDocExaminationScreen(beneficiaryRegID, benVisitID)).thenReturn("");
