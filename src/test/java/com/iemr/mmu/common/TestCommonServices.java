...
public class TestCommonServices {
	...
	public static void initializeParams() {
		...
		// when(benMenstrualDetailsRepoMock.updateMenstrualDetails(Matchers.anyShort(),Matchers.anyString(),
		// Matchers.anyShort(), Matchers.anyString(), Matchers.anyShort(),
		// Matchers.anyString(), Matchers.anyShort(), Matchers.anyString(),
		// Matchers.any(), Matchers.anyString(), Matchers.anyString(),
		// Matchers.anyLong(),
