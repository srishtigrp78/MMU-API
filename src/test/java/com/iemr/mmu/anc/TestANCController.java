...
public class TestANCController
{
	...
	getBenVisitDetailsFrmNurseANC
	ancServiceImpl.getBenVisitDetailsFrmNurseANC(benRegID, benVisitID);
	
	getBenANCDetailsFrmNurseANC
	ancServiceImpl.getBenANCDetailsFrmNurseANC(benRegID, benVisitID);
	
	getBenANCHistoryDetails
	ancServiceImpl.getBenANCHistoryDetails(benRegID, benVisitID);
	
	getBenANCVitalDetailsFrmNurseANC
	ancServiceImpl.getBeneficiaryVitalDetails(benRegID, benVisitID);
	
	getBenExaminationDetailsANC
	ancServiceImpl.getANCExaminationDetailsData(benRegID, benVisitID);
	
	getBenANCPastHistory
	ancServiceImpl.getANCPastHistoryData(benRegID);
	
	getBenANCTobaccoHistory
	 ancServiceImpl.getANCPersonalTobaccoHistoryData(benRegID);
	
	getBenANCAlcoholHistory
	ancServiceImpl.getANCPersonalAlcoholHistoryData(benRegID);
	
	getBenANCAllergyHistory
	ancServiceImpl.getANCPersonalAllergyHistoryData(benRegID);
	
	getBenANCMedicationHistory
	 ancServiceImpl.getANCMedicationHistoryData(benRegID);
	
	getBenANCFamilyHistory
	ancServiceImpl.getANCFamilyHistoryData(benRegID);
	
	getBenANCMenstrualHistory
	ancServiceImpl.getANCMenstrualHistoryData(benRegID);
	
	getBenANCPastObstetricHistory
	ancServiceImpl.getANCObstetricHistoryData(benRegID);
	
	getBenANCComorbidityConditionHistory
	ancServiceImpl.getANCComorbidHistoryData(benRegID);
	
	getBenANCOptionalVaccineHistory
	ancServiceImpl.getANCChildVaccineHistoryData(benRegID);
	
	getBenANCImmunizationHistory
	ancServiceImpl.getANCImmunizationHistoryData(benRegID);*/
