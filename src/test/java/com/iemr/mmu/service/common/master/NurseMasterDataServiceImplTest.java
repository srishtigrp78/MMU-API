...
class NurseMasterDataServiceImplTest {
	...
	void testGetCancerScreeningMasterDataForNurse() {
		...
		// Act
		String actualCancerScreeningMasterDataForNurse = nurseMasterDataServiceImpl
				.getCancerScreeningMasterDataForNurse();
	...
	void testGetCancerScreeningMasterDataForNurse5() {
		...
		verify(visitReasonMasterRepo).getVisitReasonMaster();
		assertEquals(
				"{\"frequencyOfAlcoholIntake\":[],\"oilConsumed\":[],\"dietTypes\":[],\"typeOfTobaccoProducts\":[],"
