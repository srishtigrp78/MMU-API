...
class CSCarestreamServiceImplTest {
	...
	void testCreateMamographyRequest4() {
		// Arrange
		ArrayList<Object[]> benDataForCareStream = new ArrayList<>();
		benDataForCareStream.add(new Object[] { "42", "42", "42" });
	...
	void testCreateMamographyRequest5() {
		// Arrange
		ArrayList<Object[]> benDataForCareStream = new ArrayList<>();
		benDataForCareStream.add(new Object[] { mock(Date.class), "42", "42" });
	...
	void testCreateMamographyRequest6() {
		// Arrange
		ArrayList<Object[]> benDataForCareStream = new ArrayList<>();
		benDataForCareStream.add(new Object[] { "42", "42", mock(Date.class) });
	...
	void testCreateMamographyRequest7() {
		// Arrange
		ArrayList<Object[]> benDataForCareStream = new ArrayList<>();
		benDataForCareStream.add(new Object[] { "42", "42", null });
