...
class ReportCheckPostImplNewTest {
	...
	void testGetReportMaster() throws Exception {
		// Arrange
		when(reportMasterRepo.findByServiceIDAndDeletedOrderByReportNameAsc(Mockito.<Integer>any(),
				Mockito.<Boolean>any())).thenReturn(new ArrayList<>());

		// Act
		String actualReportMaster = reportCheckPostImplNew.getReportMaster(1);
	...
	void testGetReportMaster2() throws Exception {
		...
		when(reportMasterRepo.findByServiceIDAndDeletedOrderByReportNameAsc(Mockito.<Integer>any(),
				Mockito.<Boolean>any())).thenReturn(reportMasterList);
	...
	void testReportHandler() throws Exception {
		...
		assertThrows(Exception.class, () -> reportCheckPostImplNew.reportHandler(""));
		assertThrows(Exception.class, () -> reportCheckPostImplNew.reportHandler(null));
	}
}
