...
//***********
	...
	void testUpdateHistoryNurse_Exception() throws Exception {
		...
		when(ncdScreeningService.UpdateNCDScreeningHistory(any())).thenThrow(NotFoundException.class);

		String UpdateHistoryNurse = ncdController.updateHistoryNurse(requestObj);
	...
	@Test
	void testUpdateVital_Exception() throws Exception {
		String requestObj = "{\"request\":\"Save cancer screening nurse data\"}";

		when(ncdScreeningServiceImpl.updateBenVitalDetails(any())).thenThrow(NotFoundException.class);

		String UpdateVital = ncdController.updateVitalNurse(requestObj);

		assertTrue(UpdateVital.contains("Unable to modify data"));
	}
	...
	@Test
	void testUpdateIDRSScreen_Exception() throws Exception {
		String requestObj = "{\"request\":\"Save cancer screening nurse data\"}";

		when(ncdScreeningService.UpdateIDRSScreen(any())).thenThrow(NotFoundException.class);

		String UpdateIDRSScreen = ncdController.updateIDRSScreen(requestObj);

		assertTrue(UpdateIDRSScreen.contains("Unable to modify data"));
	}
	...
	@Test
	void testUpdateDoctorData_Exception() throws Exception {
		String requestObj = "{\"request\":\"Save cancer screening nurse data\"}";

		when(ncdSCreeningDoctorService.updateDoctorData(any())).thenThrow(NotFoundException.class);

		String UpdateDoctorData = ncdController.updateDoctorData(requestObj);

		assertTrue(UpdateDoctorData.contains("Unable to modify data"));
	}
