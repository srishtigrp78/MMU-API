...
public class TestUpdateNurseANCController {
	...
	public void updateBenAdherence() {
		try {
			...
			mockMvc.perform(
					post("/anc/update/visitDetails/adherence").contentType(MediaType.APPLICATION_JSON).content(json))
	...
	public void updateBenchiefComplaints() {
		try {
			...
			mockMvc.perform(post("/anc/update/visitDetails/chiefComplaints").contentType(MediaType.APPLICATION_JSON)
					.content(json))
					.andExpect(content().string(
	...
	public void updateBenInvestigations() {
		try {
			...
			mockMvc.perform(post("/anc/update/visitDetails/investigations").contentType(MediaType.APPLICATION_JSON)
					.content(json))
					.andExpect(content().string(
	...
	public void updateBenANCDetails() {
		try {
			...
			mockMvc.perform(post("/anc/update/ANC/ANCDetails").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(content().string(
	...
	public void updateBenANCImmunizationDetails() {
		try {
			...
			mockMvc.perform(post("/anc/update/ANC/ANCImmunizationDetails").contentType(MediaType.APPLICATION_JSON)
					.content(json))
					.andExpect(content().string(
	...
	public void updateBenANCPastHistoryDetails() {
		try {
			...
			mockMvc.perform(post("/anc/update/history/pastHistoryDetails").contentType(MediaType.APPLICATION_JSON)
					.content(json))
					.andExpect(content().string(
	...
	public void updateANCBenComorbidConditions() {
		try {
			...
			mockMvc.perform(post("/anc/update/history/comorbidConditions").contentType(MediaType.APPLICATION_JSON)
					.content(json))
					.andExpect(content().string(
	...
	public void testPositiveUpdateANCMedicationHstory() {
		try {
			...
			mockMvc.perform(
					post("/anc/update/history/medicationHistory").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(content().string(
	...
	public void updateANCBenPersonalHistory() {
		try {
			...
			mockMvc.perform(
					post("/anc/update/history/personalHistory").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(content().string(
	...
	public void updateANCBenFamilyHistory() {
		try {
			...
			mockMvc.perform(
					post("/anc/update/history/familyHistory").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(content().string(
	...
	// .content(json)).andExpect(content().string("{\"data\":{\"response\":\"Beneficiary
	// ANC Child Optional Vaccine History Details updated
	...
	public void testPositiveUpdateANCVitals() {
		try {
			...
			mockMvc.perform(post("/anc/update/vitals").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(content().string(
