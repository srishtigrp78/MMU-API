...
class WrapperAncImmunizationTest {
	...
	void testGettT_1Status() {
		...
		String res = wrapperAncImmunization.gettT_1Status();
	...
	void testGettT1ID() {
		// Arrange, Act and Assert
		assertEquals(0, wrapperAncImmunization.gettT1ID());
	}

	@Test
	void testGettT2ID() {
		// Arrange, Act and Assert
		assertEquals(0, wrapperAncImmunization.gettT2ID());
	}

	@Test
	void testGettT3ID() {
		// Arrange, Act and Assert
		assertEquals(0, wrapperAncImmunization.gettT3ID());
	}
