...
public interface BenAllergyHistoryRepo extends CrudRepository<BenAllergyHistory, Long>{
	...
	@Query("select allergyStatus, allergyType, allergyName, allergicReactionTypeID, allergicReactionType, otherAllergicReaction, remarks "
	...
	public ArrayList<Object[]> getBenPersonalAllergyDetail(@Param("benRegID") Long benRegID, @Param("benVisitID") Long benVisitID);
