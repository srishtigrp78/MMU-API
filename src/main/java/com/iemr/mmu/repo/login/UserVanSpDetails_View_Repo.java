...
public interface UserVanSpDetails_View_Repo extends CrudRepository<UserVanSpDetails_View, Long> {
	@Query("SELECT t.userID, t.vanID, t.vanNoAndType, t.vanSession,t.servicePointID, t.servicePointName, t.parkingPlaceID  FROM UserVanSpDetails_View t WHERE t.userID =:userID AND "
