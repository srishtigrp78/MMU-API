...
public class NCDScreeningServiceImpl implements NCDScreeningService {
	...
	public Integer handleSaveNCDScreeningRequest(JsonObject jsonObject) throws Exception {
		...
		BenAnthropometryDetail anthropometryDetail = InputMapper.gson().fromJson(ncdScreeningDetails,
				BenAnthropometryDetail.class);
		BenPhysicalVitalDetail physicalVitalDetail = InputMapper.gson().fromJson(ncdScreeningDetails,
		...
		if (null != visitID) {
			...
			Long saveAnthropometryDetail = nurseServiceImpl
			...
			if (null != saveAnthropometryDetail && null != savePhysicalVitalDetails
					&& null != saveNCDScreeningDetails) {
