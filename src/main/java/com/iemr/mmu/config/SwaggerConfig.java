 ...
 * .apis(RequestHandlerSelectors.basePackage("com.iemr.mmu.controller")).build()
 * .apiInfo(metaData()); }
 * 
 * private ApiInfo metaData() { ApiInfo apiInfo = new ApiInfo("MMU API",
 * "The AMRIT Mobile Medical Unit (MMU) is a mobile healthcare service that offers medical assistance and tests, provides medicines, and can collect and transmit data to the AMRIT application, even without an internet connection."
